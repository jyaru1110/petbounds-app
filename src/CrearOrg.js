                ...
                <section class="register-photo">
                    <div class="form-container">
                        <form method="post">
                            ...
                            <div class="form-group"><input class="form-control" type="email" name="correo-org" placeholder="Correo"/></div>
                            <div class="form-group"><input class="form-control" type="text" placeholder="Nombre de la organización"/></div>
                            <div class="form-group"><input class="form-control" type="tel" placeholder="Número telefónico de la organización"/></div>
                            <div class="form-group"><input class="form-control" type="password" placeholder="Contraseña"/></div>
                            <div class="form-group"><input class="form-control" type="url" placeholder="Página web"/></div>
