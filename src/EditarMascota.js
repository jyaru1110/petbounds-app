...
function EditarMascota(props) {
  ...
  return (
      <div>
        ...
        <Cuerpo data={data} idMas={props.match.params.idMas}></Cuerpo>
      </div>
    );
  }
}
