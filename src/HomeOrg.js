...
const REGISTRO_MAS = gql`
  mutation (
    $registroMascotaId: ID!
    $registroMascotaTipo: String
    $registroMascotaRaza: String
    $registroMascotaEdad: String
    $registroMascotaHistoria: String
    $registroMascotaNombre: String
    $registroMascotaFoto: String
    $registroMascotaTamano: String
    $registroMascotaSexo: String
  ) {
    registroMascota(
      id: $registroMascotaId
      tipo: $registroMascotaTipo
      raza: $registroMascotaRaza
      edad: $registroMascotaEdad
      historia: $registroMascotaHistoria
      nombre: $registroMascotaNombre
      foto: $registroMascotaFoto
      tamano: $registroMascotaTamano
      sexo: $registroMascotaSexo
    ) {
      success
      message
    }
...
function HomeOrg(props) {
  ...
  if (error) return <Error />;
    ...
    localStorage.setItem("nombreOrg", data.organizacion.nombre);
    localStorage.setItem("fotoOrga", data.organizacion.foto);
    localStorage.setItem("validacionOrg", data.organizacion.validacion);
    localStorage.setItem("stripeidOrg", data.organizacion.stripeid);
...
function Cuerpo(props) {
  ...
  const [registrarMas] = useMutation(REGISTRO_MAS, {
    variables: {
      registroMascotaId: localStorage.getItem("idOrg"),
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-group d-flex justify-content-center">
              <div className="d-flex d-md-flex justify-content-center align-items-center justify-content-md-center align-items-md-center div-img-label-add">
                <img className="div-input-file-a" id="foto-mascota" />
                <input
